 ...
 * @since 0.5.0
 */
inline fun <reified R, reified Q : Any> QueryGateway.subscriptionQuery(query: Q): Publisher<R> =
 ...
 * @since 0.5.0
 */
inline fun <reified R, reified Q : Any> QueryGateway.streamingQuery(query: Q): Publisher<R> =
